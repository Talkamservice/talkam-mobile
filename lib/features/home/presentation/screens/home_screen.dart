...
class _HomeScreenState extends State<HomeScreen>
  ...
  void initState() {
    ...
    // time the drawer is opened, instead of fetching (and flashing a
    // loading state) on every open. The drawer's own groups/topics data
    // comes from `DrawerDataCubit`, prefetched by `AppDrawer` itself.
