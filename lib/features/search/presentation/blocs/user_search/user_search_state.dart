...
class UserSearchState with _$UserSearchState {
  ...
  const factory UserSearchState.userSearchLoaded(
      {required List<UserSearchResult> postResults, required UserPaginationMeta paginationData}) = _UserSearcLoaded;

  const factory UserSearchState.getUserSearchLoading() = _UserSearchLoading;


  const factory UserSearchState.getUserSearchFailed(String error) = _UserSearchFailed;
