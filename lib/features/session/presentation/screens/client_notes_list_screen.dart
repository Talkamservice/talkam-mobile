...
class _ClientNotesListScreenState extends State<ClientNotesListScreen> {
  ...
  final List<Map<String, String>> _notesList = const [
    ...
    },
    {
      ...
      "content": "Client reported significant progress in anxiety management techniques practiced over the last week. Discussed sleep hygiene routines and cognitive reframing."
    },
    {
      "name": "Martinez",
      "time": "1h ago",
      ...
      "content": "Focused on work stress strategies. Recommended mindfulness exercises during peak morning hours."
    },
    {
      "name": "Nguyen",
      "time": "2h ago",
      ...
      "content": "Reviewed mood log entries. Identified cognitive distortions around social interactions."
    },
    {
      "name": "Smith",
      "time": "3h ago",
      ...
      "content": "Initial baseline assessment completed. Established 4-week therapy goals focused on burnout prevention."
    },
  ];
