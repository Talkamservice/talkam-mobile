...
class _GroupRequestsScreenState extends State<GroupRequestsScreen> {
  ...
  void initState() {
    super.initState();
    bloc.getPendingRequests(widget.groupId);
  }
              ...
              listener: (context, state) {
                state.maybeWhen(
                  ...
                  requestActionSuccess: (response) {
                    ...
                    bloc.getPendingRequests(widget.groupId, refresh: false);
                  },
                    ...
                    if (response.data.data.isEmpty) {
                      return const Center(
                        child: EmptyState(
                          ...
                          subtitle: "Pending requests will show here if there are any",
                        ),
                      );
                    }
                          ...
                          child: PendingRequestItem(
                            ...
                            onRequestAction: (requestAction) {
                              bloc.acceptOrDeclineRequest(
                                memberId: response.data.data[index].id.toString(),
