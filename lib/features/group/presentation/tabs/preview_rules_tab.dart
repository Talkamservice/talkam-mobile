...
class PreviewGroupRulesTab extends StatefulWidget {
  ...
  @override
  State<PreviewGroupRulesTab> createState() => _PreviewGroupRulesTabState();
}

class _PreviewGroupRulesTabState extends State<PreviewGroupRulesTab> {
  @override
...
class GroupRuleItem extends StatelessWidget {
  ...
  final GuidelinePayload guidline;
