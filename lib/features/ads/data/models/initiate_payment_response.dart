...
InitiatePaymentResponse initiateSubscriptionResponseFromJson(String str) => InitiatePaymentResponse.fromJson(json.decode(str));

String initiateSubscriptionResponseToJson(InitiatePaymentResponse data) => json.encode(data.toJson());
