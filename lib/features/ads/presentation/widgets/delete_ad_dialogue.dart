...
class DeleteAdDialog extends StatelessWidget {
  const DeleteAdDialog({super.key, required this.onCancel});
      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            6.verticalSpace,
            const TextView(
              text: "You are about to delete this closed Ad, you will lose all the information pertaining to the Ad, Are you sure?",
              fontSize: 12,
              color: Pallets.grey,
              align: TextAlign.center,
            ),
