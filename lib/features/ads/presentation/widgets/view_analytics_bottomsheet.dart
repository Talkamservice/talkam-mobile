...
class ViewAnalyticsBottomSheet extends StatefulWidget {
  const ViewAnalyticsBottomSheet({super.key, required this.postId});

  final String postId;

  @override
  State<ViewAnalyticsBottomSheet> createState() =>
      _ViewAnalyticsBottomSheetState();
}
...
class _ViewAnalyticsBottomSheetState extends State<ViewAnalyticsBottomSheet> {
  ...
  @override
  void initState() {
    bloc.getAnalytics(true,widget.postId);
    super.initState();
  }
              ...
              children: [Column(
                ...
                children: [
                  Row(
                    ...
                    children: [
                      Text("Post analytics", style: TextStyle(fontSize: 12, fontWeight: FontWeight.bold),),
                      GestureDetector(
                          onTap: Navigator.of(context).pop,
                          child: ImageWidget(imageUrl: Assets.images.svgs.cancelOutlined,height: 10.49, width: 10.49,)
                      )
                    ],
                  ),
                  Divider(
                  ...
                  Text("Get more insights into how well your post is doing.",
                    style: TextStyle(
                      fontSize: 12,
