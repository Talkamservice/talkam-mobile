...
class _SystemAdminTabState extends State<SystemAdminTab> with AutomaticKeepAliveClientMixin {
  ...
  @override
  void initState() {
    bloc.add(GetNotificationsEvent(tab: "system_admin"));
    _scrollController.addListener(() {
      if (_scrollController.position.pixels == _scrollController.position.maxScrollExtent) {
        bloc.add(LoadMoreNotificationsEvent(previousNotifications: _notifications, tab: "system_admin"));
      }
    });
    super.initState();
  }
                    ...
                    children: [
                      ...
                      Expanded(
                        child: RefreshIndicator(
                          onRefresh: () async {
                            bloc.add(const GetNotificationsEvent(tab: "system_admin"));
                          },
